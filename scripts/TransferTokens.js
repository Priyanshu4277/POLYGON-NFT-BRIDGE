...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Rambat");
  const nft = await NFT.attach("0x3732f412BE5dbD464fbc5e2F22a5af175dC25604");
  ...
  // Approve the Rambat nfts for transfer
