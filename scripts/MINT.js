...
async function main() {
  ...
  const contractAddress = "0x3732f412BE5dbD464fbc5e2F22a5af175dC25604";

  // Get the contract factory for the Rambat contract and attach it to the signer
  const OneNFT = await ethers.getContractFactory("Rambat", signer);
